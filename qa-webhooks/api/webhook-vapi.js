...
//
// The transcript is run through analyzeTranscript() (lib/analyze.js), which
// checks it against the same rules written into Nova's system prompt. If
// nothing is wrong, NO ticket is created — a clean call stays clean. Each
// issue found becomes its own ticket, starting as Unassigned so a human
// still has to claim it before work begins.
